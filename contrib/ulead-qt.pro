...
RESOURCES += src/qt/ulead.qrc src/qt/ulead_locale.qrc

TRANSLATIONS += src/qt/locale/ulead_bg.ts \
                src/qt/locale/ulead_de.ts \
                src/qt/locale/ulead_en.ts \
                src/qt/locale/ulead_es.ts \
                src/qt/locale/ulead_fi.ts \
                src/qt/locale/ulead_fr.ts \
                src/qt/locale/ulead_it.ts \
                src/qt/locale/ulead_ja.ts \
                src/qt/locale/ulead_pl.ts \
                src/qt/locale/ulead_pt.ts \
                src/qt/locale/ulead_ru.ts \
                src/qt/locale/ulead_sk.ts \
                src/qt/locale/ulead_sv.ts \
                src/qt/locale/ulead_vi.ts \
                src/qt/locale/ulead_zh_CN.ts \
                src/qt/locale/ulead_zh_TW.ts
