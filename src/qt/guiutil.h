...
/** Utility functions used by the ULead Qt UI.
 */
namespace GUIUtil
{
...
// Render ULead addresses in monospace font
...
// Parse "ulead:" URI into recipient object, return true on successful parsing
