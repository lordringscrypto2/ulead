                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzuleadPathCustom = GetArg("-zuleadbackuppath", "");
    ...
    if(!strzuleadPathCustom.empty()) {
        ui->wallet_customzuleadbackuppath->setText(QString::fromStdString(strzuleadPathCustom));
        ui->wallet_customzuleadbackuppath_label->setVisible(true);
        ui->wallet_customzuleadbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzuleadPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ULead RPC console.") + "<br>" +
