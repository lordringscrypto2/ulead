                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ULead Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ULead address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ulead: URIs)"));
    ...
    //privacyAction->setStatusTip(tr("Privacy Actions for zULEAD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ULead Core"), this);
    aboutAction->setStatusTip(tr("Show information about ULead Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ULead"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ULead addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ULead addresses"));
    ...
    openAction->setStatusTip(tr("Open a ULead: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ULead Core help message to get a list with possible ULead command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ULead Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ULead network", "", count));
}
...
{
    QString strTitle = tr("ULead Core"); // default title
