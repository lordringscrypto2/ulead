...
/* ULead GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ULead"
#define QAPP_ORG_DOMAIN "ulead.org"
#define QAPP_APP_NAME_DEFAULT "ULead-Qt"
#define QAPP_APP_NAME_TESTNET "ULead-Qt-testnet"
