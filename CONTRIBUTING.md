Contributing to ULead Core
============================

The ULead Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ULead Core project, and is not to be
confused with overall ULead Network Protocol consensus changes.

Whether a pull request is merged into ULead Core rests with the project merge
...
Patches that change ULead consensus rules are considerably more involved than
...
Where a patch set proposes to change the ULead consensus, it must have been
...
The project leader is the release manager for each ULead Core release.
