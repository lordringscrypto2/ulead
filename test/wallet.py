...
#   c) node1 mines 32 blocks, so now node 0 has 60001ulead, node 1 has 4250ulead, node2 has none.
#   d) node0 sends 601 ulead to node2, in two transactions (301 ulead, then 300 ulead).
