...
In order to support loading of multiple wallets in ulead-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ulead.cpp.
...
Changes to ulead.cpp
----------------------
ulead.cpp is the entry point into ulead-qt, and as such, will require some minor modifications to provide hooks for
